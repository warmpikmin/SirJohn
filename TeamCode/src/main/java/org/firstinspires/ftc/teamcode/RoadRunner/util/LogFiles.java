...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = RRMecanum.TRANSLATIONAL_PID.kP;
        public double mecTransI = RRMecanum.TRANSLATIONAL_PID.kI;
        public double mecTransD = RRMecanum.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = RRMecanum.HEADING_PID.kP;
        public double mecHeadingI = RRMecanum.HEADING_PID.kI;
        public double mecHeadingD = RRMecanum.HEADING_PID.kD;
        public double mecLateralMultiplier = RRMecanum.LATERAL_MULTIPLIER;
